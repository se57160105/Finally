...
public class Cincome extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cincome);
        new NukeSSLCerts().nuke();
        //Date = (TextView)rootView.findViewById(R.id.Date);
        Cincome = (TextView)findViewById(R.id.Cincome);
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, "https://10.51.4.17/TSP57/SMEs/index.php/account/reports/Api_android_sun/get_income",
